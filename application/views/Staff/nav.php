                ...
                <ul class="nav navbar-nav">
					...
					<li class="menu-item">
                        ...
                        <a href="<?php echo base_url() . $user ?>/patients"> 
                            <i class="menu-icon fa fa-id-card"></i>Patients
                        </a>

                        <a href="<?php echo base_url() . $user ?>/doctor_schedule"> 
                            <i class="menu-icon fa fa-calendar"></i>Doctor Schedule
                        </a>

                        <a href="<?php echo base_url() . $user ?>/appointments"> 
                            <i class="menu-icon fa fa-user-md"></i>Appointments
                        </a>

                        <a href="<?php echo base_url() . $user ?>/archives"> 
                            <i class="menu-icon fa fa-file"></i>Archives
                        </a>
                    </li>

                    <!-- <h3 class="menu-title">R. E. D.</h3><!-- /.menu-title 
